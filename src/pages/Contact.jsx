    ...
    <>
        ...
        <div className='flex flex-col justify-center pt-8 mx-auto items-center text-center'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 w-[80%] mx-auto gap-16 justify-center items-center my-16'>
                ...
                <form action="" className='bg-[#e87829] px-8 py-8 rounded-lg flex flex-col gap-4 text-white h-full text-left'>
                    ...
                    <button className='mx-auto bg-[#8f2269] text- px-5 py-3 rounded-full transition w-[10rem] text-white'>Submit</button>
